document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('clear-chat').addEventListener('click', () => {
    ...
    if (!lobbyName) {
      document.getElementById('clear-chat-status').textContent = 'Please enter a lobby name.';
      return;
    }
    ...
    .then(data => {
      if (data.success) {
        document.getElementById('clear-chat-status').textContent = `Chat history cleared for lobby '${lobbyName}'.`;
      } else {
        document.getElementById('clear-chat-status').textContent = data.message;
      }
    })
    .catch(error => {
  ...
  document.getElementById('kick-user').addEventListener('click', () => {
    ...
    if (!usernameToKick || !lobbyToKick) {
      document.getElementById('kick-user-status').textContent = 'Please enter both username and lobby name.';
      return;
    }
